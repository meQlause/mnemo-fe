  ...
  return (
    <div
      className={cn(
        ...
        'prose-code:px-1.5 prose-code:py-0.5 prose-code:rounded-[4px] prose-code:bg-[--color-paper-mid] prose-code:text-[--color-ink] prose-code:font-mono prose-code:text-[0.85em] prose-code:before:content-none prose-code:after:content-none',
